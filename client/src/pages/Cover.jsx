...
//         <div className="title">THE MARTECH SUMMIT</div>
//         <div className="content">
//           <h1>Accelerate Success with Your MarTech Stack</h1>
//           <p>Leaner, Smarter & Richer</p>
//           <p>In Person | Singapore | 25 & 26 April 2023</p>
//           <p>Raffles City Convention Centre</p>
//           <div className="buttons">
//             <a href="#" className="button">Registration</a>
//             <a href="#" className="button">Apply to Speak/Sponsor</a>
//           </div>
//         </div>
//         </div>
//     </header>
...
//       &copy; 2023 The Martech Summit | All Rights Reserved
//     </footer>
//   </div>
//   );
// };
    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 "style={{ background: 'rgba(128, 128, 128, 0.5)' }}  />
          <img
            src="/cover.jpg"
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
          ...
          >
            ...
            >
              ...
              Join Virtually | Anywhere in the World | Elevate Your Experience at #VirtuLink
              </p>
              {/* <p>Raffles City Convention Centre</p> */}
