    ...
    const onSubmit = async (e) => {
        ...
        if(!isSigningIn) {
            ...
            try {
                ...
                setIsSigningIn(false); // Reset signing-in state after error
    ...
    const onGoogleSignIn = async (e) => {
        ...
        if (!isSigningIn) {
            ...
            try {
                ...
                setIsSigningIn(false); // Reset signing-in state after success
                Navigate('/home'); // Redirect to the home page after successful Google sign-in
              } catch (error) {
                setIsSigningIn(false); // Reset signing-in state after error
                setErrorMessage(error.message); // Set the error message if login fails
              }
